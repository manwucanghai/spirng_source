...
public abstract class AbstractHandlerMapping extends WebApplicationObjectSupport
    ...
    public final HandlerExecutionChain getHandler(HttpServletRequest request) throws Exception {
        /**
         * 调用子类的getHandlerInternal方法,获取request与之对应的Handler
         */
        Object handler = getHandlerInternal(request);
        if (handler == null) {
            //如果获取不到handler，则获取默认的handler,正常默认的为null
        ...
        if (handler instanceof String) {
            /**
             * 如果handler为字符串，则从Spring容器中获取实例对象.
             */
        ...
        /**
         * 将handler包装为HandlerExecutionChain，并添加chain的拦截器。
         * 拦截器的添加方式:
         * https://docs.spring.io/spring/docs/5.1.14.BUILD-SNAPSHOT/spring-framework-reference/web.html#mvc-config-interceptors
         */
        ...
        /**
         * 判断header是否包含 Origin
         * 如果包含，则说明请求进行了跨域，需要添加 CorsInterceptor拦截器.
         */
