...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
    ...
    protected final void initServletBean() throws ServletException {
        ...
        try {
            /**
             * 初始化WebApplicationContext，完成包扫描，及bean实例化。
             */
    ...
    protected WebApplicationContext initWebApplicationContext() {
        ...
        if (this.publishContext) {
            ...
            /**
             * 将 WebApplicationContext 添加到 ApplicationContext中。
    ...
    protected void configureAndRefreshWebApplicationContext(ConfigurableWebApplicationContext wac) {
        ...
        /**
         * 《核心代码》
         * 往WebApplicationContext中添加 SourceFilteringListener 监听器
         * 该监听器的作用是？
         *      当 wac finishRefresh，发布ContextRefreshedEvent 事件，该监听器监听到ContextRefreshedEvent时间是，
         *      触发调用onRefresh(ApplicationContext context)方法，完成Spring MVC内部策略对象的初始化
         *
         */
        ...
        /**
         * 在任何post-processing or initialization之前，对environment 初始化PropertySources
         * 为 servletContextInitParams，servletConfigInitParams 为key的StubPropertySource配置ServletConfig。
         */
        ...
        /**
         * 调用后置处理器，默认为空实现，可提供子类进行扩展实现.
         */
        postProcessWebApplicationContext(wac);

        /**
         * 获取所有ApplicationContextInitializer实现类，并执行initializer方法
         */
        applyInitializers(wac);

        /**
         * 刷新WebApplicationContext，完成Spring bean扫描及实例化所有bean过程.
         */
        wac.refresh();
    }
    ...
    protected final void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /**
         * 1.获取原先的 LocaleContext，及 RequestAttributes 为了 resetContextHolders
         * 2.buildLocaleContext 及 buildRequestAttributes，并 initContextHolders，设置给request。
         */
        ...
        /**
         * 绑定 RequestBindingInterceptor 拦截器
         * 处理异步的时候会调用。
         */
